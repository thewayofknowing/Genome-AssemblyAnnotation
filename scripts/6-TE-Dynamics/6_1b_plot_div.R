...
setwd("/storage/homefs/kk22w918/Assembly/6-TE-Dynamics")

## Import the modified output from parseRM.pl ending with "landscape.Div.Rname.tab
dat <- fread("/storage/homefs/kk22w918/Assembly/6-TE-Dynamics/pilon-flye.fasta.mod.out.landscape.Div.Rname.tab.mod")
